...
def sector_performance(connection):
    ...
    df_sector = pd.read_sql("SELECT Sector, Avg_Yearly_Return FROM Ticker_Sector_YearlyReturns", connection)
    ...
    if 'Sector' in df_sector.columns and 'Avg_Yearly_Return' in df_sector.columns:
        ...
        df_stocks.rename(columns={"sector": "Sector", "Yearly_Return": "Avg_Yearly_Return"}, inplace=True)
